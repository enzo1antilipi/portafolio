...
function Proyects(){
    ...
    <div className="conteinerProyects">
      <h3 style={{alignItems:"center",color:"white"}}>Proyectos personales</h3>
         <div className="tarjeta1">
              <div className="card" style={{ width: "38rem", height: "100%" }}>
        ...
        <div className="tarjeta2">
              <div className="card" style={{ width: "38rem", height: "100%", marginTop:"10px" }}>
                <img className="card-img-top" alt="..." src={tasks} />
